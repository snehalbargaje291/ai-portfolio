...
const Card: React.FC<CardProps> = ({ src, description, title, techstack, link }) => (
  <motion.a
    ...
    className="relative block h-72 bg-background border hover:border-none border-gray-500 shadow-xl rounded-lg overflow-hidden transition-transform duration-300 ease-in-out group"
    initial="initial"
    animate="animate"
    exit="exit"
